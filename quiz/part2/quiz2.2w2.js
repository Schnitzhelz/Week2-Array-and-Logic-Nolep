...
note kenapa angka 8 adalah palindrome? karena angka 8 dibalik tetep 8 
note kenapa angka 343 adalah palindrome? karena angka 343 dibalik tetep 343 
*/


  function angkaPalindrome(number) {
    for (let i = number + 1; ; i++) { //looping angka 
      let str = String(i); //ubah num ke str
      let reversed = str.split('').reverse().join(''); //str reverse untuk dibandingkan dengan str 
      if (str === reversed) {
        return i;
      }
    }
...
//berikan saya tahapan penyelesaian nya
